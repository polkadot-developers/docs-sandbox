...
[Install with Cargo](#install-with-cargo) section.

<Message
  type={`yellow`}
  title={`Important`}
  text={`If you follow the steps in this section to compile Subkey with Cargo, the version of Subkey will
