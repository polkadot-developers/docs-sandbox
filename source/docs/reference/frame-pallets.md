...
| Prebuilt pallet name | What it's for
| -------------------- | ------------------------------------
| [`cumulus-pallet-aura-ext`](https://github.com/paritytech/cumulus/tree/master/pallets/aura-ext) | AURA consensus extension pallet for parachains.
| [`pallet-collator-selection`](https://github.com/paritytech/cumulus/tree/master/pallets/collator-selection) | A pallet to manage collators in a parachain.
| [`cumulus-pallet-dmp-queue`](https://github.com/paritytech/cumulus/tree/master/pallets/dmp-queue) | A pallet that implements a message queue for downward messages from the relay-chain.
| [`cumulus-pallet-parachain-system`](https://github.com/paritytech/cumulus/tree/master/pallets/parachain-system) | Base pallet for cumulus-based parachains.
| [`cumulus-pallet-solo-to-para`](https://github.com/paritytech/cumulus/tree/master/pallets/solo-to-para) | A pallet which adds functionality to migrate from a Solo to a Parachain.
| [`cumulus-pallet-xcm`](https://github.com/paritytech/cumulus/tree/master/pallets/xcm) | A pallet for stuff specific to a parachain's usage of XCM.
| [`cumulus-pallet-xcmp-queue`](https://github.com/paritytech/cumulus/tree/master/pallets/xcmp-queue) |  A pallet which uses the XCMP transport layer to handle both incoming and outgoing XCM message sending and dispatch, queuing, signalling and backpressure.
